...
CREATE TABLE IF NOT EXISTS "CreditWallets" (
    ...
    CONSTRAINT "FK_CreditWallets_Users_UserId" FOREIGN KEY ("UserId") REFERENCES "Users" ("Id") ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "GenerationJobs" (
    ...
    CONSTRAINT "FK_GenerationJobs_Users_UserId" FOREIGN KEY ("UserId") REFERENCES "Users" ("Id") ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "GalleryItems" (
    ...
    CONSTRAINT "FK_GalleryItems_Users_UserId" FOREIGN KEY ("UserId") REFERENCES "Users" ("Id") ON DELETE CASCADE
);
...
INSERT INTO "Users" ("Id", "Email", "PasswordHash", "DisplayName", "Role", "CreatedAtUtc") VALUES
('a0000000-0000-4000-8000-000000000001', 'admin@fashion.local', '100000.So8sEZ5VdwO6bR+IRMKQWg==.5esf5PVGXuuMrLv/RFDqmNxRlJYjOQZc1q5tyuC5PH8=', 'Admin', 'admin', NOW() AT TIME ZONE 'UTC')
ON CONFLICT DO NOTHING;

INSERT INTO "CreditWallets" ("Id", "UserId", "Balance") VALUES
('b0000000-0000-4000-8000-000000000001', 'a0000000-0000-4000-8000-000000000001', 500)
ON CONFLICT DO NOTHING;

INSERT INTO "CreditTransactions" ("Id", "UserId", "Amount", "Type", "Description", "CreatedAtUtc") VALUES
('c0000000-0000-4000-8000-000000000001', 'a0000000-0000-4000-8000-000000000001', 500, 1, 'Initial seed credits', NOW() AT TIME ZONE 'UTC')
ON CONFLICT DO NOTHING;
