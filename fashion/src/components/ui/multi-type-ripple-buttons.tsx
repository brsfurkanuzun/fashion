...
export const RippleButton = ({
  ...
  if (variant === 'hover') {
    ...
    return (
      <>
        ...
        <button type="button" className={hoverButtonFinalClassName} onClick={handleButtonClick} disabled={disabled}>
  ...
  if (variant === 'hoverborder') {
    ...
    return (
      <>
        <style dangerouslySetInnerHTML={{ __html: JS_RIPPLE_KEYFRAMES }} />
        <style dangerouslySetInnerHTML={{ __html: dynamicGridHoverStyles }} />
        <button type="button" className={hoverBorderButtonFinalClassName} onClick={handleButtonClick} disabled={disabled}>
          <span className="relative z-[10] pointer-events-none">{children}</span>
          {jsRippleElements}
          <div
  ...
  if (variant === 'ghost') {
    ...
    return (
      <>
        <style dangerouslySetInnerHTML={{ __html: JS_RIPPLE_KEYFRAMES }} />
        <button type="button" className={ghostButtonFinalClassName} onClick={handleButtonClick} disabled={disabled}>
          <span className="relative z-10 pointer-events-none">{children}</span>
          {jsRippleElements}
        </button>
      </>
  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{ __html: JS_RIPPLE_KEYFRAMES }} />
      <button type="button" className={buttonClasses} onClick={handleButtonClick} disabled={disabled}>
